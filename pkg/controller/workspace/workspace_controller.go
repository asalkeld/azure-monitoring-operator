...
import (
	...
	monitoringv1 "github.com/openshift/azure-monitoring-operator/pkg/apis/monitoring/v1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &monitoringv1.Workspace{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &monitoringv1.Workspace{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileWorkspace) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &monitoringv1.Workspace{}
...
func newPodForCR(cr *monitoringv1.Workspace) *corev1.Pod {
